    ...
    return (
        <>
            ...
            <div className="container-fluid" style={{marginTop: "7rem"}}>
                <iframe src="https://pancakeswap.finance/swap?outputCurrency=0x3244B3B6030f374bAFA5F8f80Ec2F06aAf104B64" scrolling="yes" className="iframe-class" width="100%" height="925" frameBorder="0">
                </iframe>
            </div>
            <Foot />
        </>
