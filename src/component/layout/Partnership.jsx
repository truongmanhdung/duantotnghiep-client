            ...
            <div className="container">
                ...
                <div className="list-patner">
                    <div className="patner-item">
                        <img src="https://herofi.b-cdn.net/wp-content/uploads/2021/10/logo-hg.png" alt="" />
                    </div>
                    <div className="patner-item">
                        <img src="https://herofi.b-cdn.net/wp-content/uploads/2021/10/logo-ght.png" alt="" />
                    </div>
                    <div className="patner-item">
                        <img src="https://herofi.b-cdn.net/wp-content/uploads/2021/10/logo-infinity.png" alt="" />
                    </div>
                    <div className="patner-item">
